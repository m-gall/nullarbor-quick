...
$make{'again'} = {
  CMD => "(rm -fr roary/ roary_*/ report/ preview.* tree.* distances.tab && cd .. && @CMDLINE_NO_FORCE --force)",
};
...
report-population/index.html : yield denovo.tab mlst.tab core.aln virulome resistome amrfinder plasmidome core.svg distances.tab
