...
sub write_makefile {
  ...
  print $fh "BINDIR := /project/RDS-FMH-PGRepo-RW/tools/nullarbor2.0/v2.0-skippy/bin\n";
...
#  print $fh "TAXONER := cpus=\$(CPUS) opts=\"$taxoner_opt\" ", $plugin->{taxoner}{kraken}, "\n";
  ...
  print $fh "AMRFINDER := perl /project/RDS-FMH-PGRepo-RW/tools/amrfinder/amrfinder.pl -n\n";
  print $fh "MLST := mlst\n";
...
report-isolate/index-fast-isolate.html : ref.fa.fai yield core mlst virulome resistome plasmidome amrfinder
