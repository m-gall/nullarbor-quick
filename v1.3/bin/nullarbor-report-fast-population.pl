...
use lib "/tmp/nullarbor_mgall/v1.3/perl5";
...
my $TEMPLATE_DIR = "/tmp/nullarbor_mgall/v1.3/conf";
my $VERSION = '1.25';
...
print "edited population report file";
...
my @section = qw(jobinfo seqdata mlst serotype resistome virulome
                 assembly reference core snptree snpdist snpdensity pan
                 tools about);
...
my $out_fn = "$outdir/index-fast-population.html";
